...
namespace ASD
{
    ...
    {
        public enum UpdateType { None, Update, FixedUpdate }
        ...
        private void HandleRotation()
        {
            ...
            {
                m_CurrentXRotation = Mathf.SmoothDamp(m_CurrentXRotation, xInputRotation, ref m_XRotationVelocity, m_SmoothDampTimeLook);//����������� ��������
